...
### Basic:
- **CVE-2012-4929: CRIME** - attack on TLS compression  ***just disable data compression** (in tls 1.2 and earlier). (TLS 1.3 completely removed compression at the TLS layer (RFC 8446, Section 4.1.2), making CRIME irrelevant for pure TLS 1.3 connections.) ❌
